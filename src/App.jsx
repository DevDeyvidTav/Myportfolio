...
export function App(props) {
  ...
  return (
    <div className="w-screen h-screen bg-zinc-200 max-h-full font-sans max-w-full ">


      <Router>
        <div className="nav-bar flex mobile:flex-col  ">
          <div className="nav-bar-1| opacity-90 flex justify-between tablet-m:mx-32
        sm:mx-0 mobile:mx-0">
            ...
            <div className=' main md:gap-3 flex gap items-center font-semibold text-zinc-700 '>
              ...
              <button className={`${open?'hidden':''} tablet-p:hidden`}>
              ...
              <button onClick={() => setOpen(!open)} className={`${open?'':'hidden'} tablet-p:hidden`}><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div className={`${open ? 'translate-x-0' : '-translate-x-full'} duration-500 flex-col gap-8 h-full w-screen absolute bg-zinc-800 `}>
