...
export function Header() {
    ...
    return (
        <div>
            <div className="shadow-black nav-bar flex mobile:flex-col fixed justify-between max-w-full shadow-md w-screen opacity-90 bg-zinc-800">
        ...
        sm:mx-0 mobile:mx-0">
            ...
            <div className={`${open ? 'translate-x-0 shadow-2xl shadow-black opacity-100 ' : '-translate-x-full opacity-0'} fixed duration-300 flex-col gap-8 h-full w-5/6 rounded-2xl rounded-l-none max-w-full bg-zinc-800 `}>
