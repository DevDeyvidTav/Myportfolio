...
import finances from '../images/finances.png'
    ...
    export function Projetos(){
        ...
        return(
            <div id='Projetos' className="tablet-m:h-full w-screen max-w-full bg-gray-200 ">
                ...
                <div className="divider| h-[1.2px] w-full  bg-gradient-to-l from-zinc-900 mb-24 to-zinc-300"></div>
                    ...
                    <div className='projects| flex flex-col w-full tablet-m:flex-row tablet-m:h-72 gap-20 tablet-m: mb-10 mt-16 ' >
                        ...
                        <div className='project3| tablet-m:w-[30%] mx-5 shadow-2xl rounded-md h-full bg-black'><img className='w-full h-full rounded-md rounded-b-none' src={finances} alt="" /><NavLink to="/finances"><button className='bg-black rounded-md rounded-t-none text-white w-full text-2xl'>Informações</button></NavLink></div>
                    </div>
                </div>
            </div>
        )
